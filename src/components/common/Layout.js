        ...
        <>
            <nav class="z-depth-0">
                ...
                <ul id="nav-mobile" className="right hide-on-med-and-down">
                    ...
                    <li><a href="https://drive.google.com/file/d/1Lxcga0Z1TeB7ki1LYpp9V023PjHu1ymT/view" class="nav-text black-text" target="_blank">resume</a></li>
                </ul>
                </div>
            </nav>
            <div>
                ...
                <div className="footer-copyright indigo lighten-5 black-text">
                    <div className="container">
                        <a href="https://github.com/nerasan">
                            <img src="https://image.flaticon.com/icons/png/512/25/25231.png" alt="github icon" class="footer-icon" />
                        </a>
                        <a href="https://www.linkedin.com/in/salimaharun/">
                            <img src="https://www.shareicon.net/data/2016/07/08/116977_address-book_512x512.png" alt="linkedin icon" class="footer-icon" />
                        </a>
                        <div>
                            © 2021 salima harun
                        </div>
